...
import { faBell, faCamera, faDoorOpen, faDoorClosed, faEarthAmericas, faFlag, faHouse, faPencil, faPenToSquare, faSquarePlus, faUser } from '@fortawesome/free-solid-svg-icons'

library.add([faBell, faCamera, faDoorOpen, faDoorClosed, faEarthAmericas, faFlag, faHouse, faPencil, faPenToSquare, faSquarePlus, faUser]);
